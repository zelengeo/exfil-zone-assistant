        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
            ...
            <div className="military-card p-4 rounded-sm">
                ...
                <div className="flex justify-between text-sm">
                    <span className="text-tan-400">Dimensions:</span>
                    <span className="text-tan-100">{item.stats.sizes}</span>
                </div>
            </div>
            ...
            <div className="military-card p-4 rounded-sm">
                ...
                <div className="space-y-3">
                    {item.stats.attachmentPoints.length ? item.stats.attachmentPoints.map((point, index) => (
                        <div key={index} className="border-l-2 border-olive-600 pl-3">
                            <div className="flex items-center gap-2 mb-1">
                                <span className="text-tan-100 font-medium capitalize">{point.tag}</span>
                            </div>
                    ...
                    <p className="text-tan-300">No attachment points defined for this backpack.</p>}
                </div>
            </div>
        </div>
    );
