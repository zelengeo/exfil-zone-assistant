...
|---|---|---|
| `/items` | the catalogue and its filters | [items](items/CLAUDE.md) |
| `/tasks` | 227 contracts as vendor chains | [tasks](tasks/CLAUDE.md) |
| `/combat-sim` | damage, penetration, TTK | [combat-sim](combat-sim/CLAUDE.md) |
| `/hideout-upgrades` | upgrade planner | [hideout-upgrades](hideout-upgrades/CLAUDE.md) |
| `/guides` | written and component guides | [guides](guides/CLAUDE.md) |
| `/gunsmith` | weapon build tool | — |
| `/admin` | moderation and health | [admin](admin/CLAUDE.md) |
| `/api` | route handlers | [api](api/CLAUDE.md) |
