...
imports only; keep project guidance here and in the scoped `AGENTS.md` files.

Every route and layer keeps its own `AGENTS.md` next to the code it describes. Read the one covering
what you are touching. `src/app/tasks/AGENTS.md` is the house style: cache the reasoning and the
